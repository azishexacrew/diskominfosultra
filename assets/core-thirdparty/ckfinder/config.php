...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://diskominfo.technos-studio.com/assets/core-images/upload/', //ganti kalau mau dihosting
    // 'baseUrl'      => 'http://localhost/coreweb_kominfo/assets/core-images/upload/', //ganti kalau mau dihosting
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['tempDirectory'] = '/Application/xampp/xamppfiles/temp'; //MacOs Version
//$config['tempDirectory'] = sys_get_temp_dir(); //Windows & Linux Version
