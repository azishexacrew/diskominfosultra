                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <div style="padding-top:10px">
                                    ...
                                    <a href="<?php echo site_url('admin/news') ?>" class="btn btn-success btn-flat" title="Refresh halaman">refresh</a>
                                    <a href="<?php echo site_url('admin/news/create_page') ?>" class="btn btn-primary btn-flat" title="Tambah data"> tambah</a>
                                </div>
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                        ...
                                        <!-- Modal Delete-->
                                        <div class="modal fade" id="modalDelete<?php echo $key->news_id; ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" class="form-control" name="idReference" required="required" value="<?php echo $key->idReference;?>">
                                                    </div>
                        ...
                        <div class="box-footer">
                            ...
                            <!-- COUNT DATA -->
                            <?php if ($news) { ?>
                                <div class="float-left">Tampil <?php echo ($nox + $numbers) . " - " . (count($news) + $numbers) . " dari " . $total_data; ?> Data</div>
                            <?php } else { ?>
