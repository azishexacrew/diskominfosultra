                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="news_category_id" required style="width:100%">
                                            ...
                                            foreach ($news_category as $f) {
                                                if ($news[0]->news_category_id == $f->news_category_id) {
                                                    echo '<option value="' . $f->news_category_id . '" selected>' . $f->news_category_name . '</option>';
                                                } else {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Judul Berita" name="news_title" required="required" value="<?php echo $news[0]->news_title; ?>">
                                        ...
                                        <input type="hidden" class="form-control" name="idReference" required="required" value="<?php echo $news[0]->idReference;?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Cover/Thumbnail Berita </b></label><br>
                                        ...
                                        <input type="file" class="form-control" placeholder="Judul Berita" name="news_cover" accept=".png, .jpeg, .jpg">

                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Isi Berita <span style="color:red">*</span></b></label>
                                        <textarea cols="80" id="editor" name="news_text" rows="10" style="resize:none;max-width:700px;" required="required"><?php echo $news[0]->news_text; ?></textarea>
                                    </div>
