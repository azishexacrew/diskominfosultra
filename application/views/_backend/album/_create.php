                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Judul album" name="album_name" required="required">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Isi Album <span style="color:red">*</span></b></label>
                                        <textarea cols="80" id="editor" name="album_description" rows="10" style="resize:none;max-width:700px;"></textarea>
                                    </div>
