...
class News extends CI_Controller
{
    ...
    public function postToAPI($data){
        ...
        $url    = "http://www.sultraprov.go.id/web-panel/pages/api.php?function=post_news";
        $header = array(
    ...
    public function updateToAPI($data){
        ...
        // START CONNECT TO API
        $url    = "http://www.sultraprov.go.id/web-panel/pages/api.php?function=update_news";
        $header = array(
                        'client-id: diskominfo',
                        'client-token: 96355148-683c-4be0-93c6-07f70e799315',
                    );
    ...
    public function removeToAPI($id){
        ...
        // START CONNECT TO API
        $url    = "http://www.sultraprov.go.id/web-panel/pages/api.php?function=delete_news";
        $header = array(
                        'client-id: diskominfo',
                        'client-token: 96355148-683c-4be0-93c6-07f70e799315',
                    );
    ...
    public function getID(){
        $url    = "http://www.sultraprov.go.id/web-panel/pages/api.php?function=get_idreference";
        $header = array(
                            'client-id: diskominfo',
                            'client-token: 96355148-683c-4be0-93c6-07f70e799315',
                        );
