...
class Regulation extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tbl_regulation_category']   = $this->m_regulation_category->read('', '', '');
    ...
    public function create()
    {
        ...
        if (!$this->upload->do_upload('regulation_file')) {
            ...
            $data['regulation_text']            = $this->input->post('regulation_text');
            $data['regulation_year']            = $this->input->post('regulation_year');
