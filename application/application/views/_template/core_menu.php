                ...
                <section class="sidebar">
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <?php
                            if (strlen($this->session->userdata('user_fullname')) > 18) {
                                echo '<p>' . substr($this->session->userdata('user_fullname'), 0, 18) . '..</p>';
                            } else {
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo site_url('admin/slider') ?>"><i class="fa fa-circle-o"></i> <span>Slider Berita</span></a></li>
                                    <li><a href="<?php echo site_url('admin/link_terkait') ?>"><i class="fa fa-circle-o"></i> <span>Link Terkait</span></a></li>
                                    <li><a href="<?php echo site_url('admin/faq') ?>"><i class="fa fa-circle-o"></i> <span>FAQ</span></a></li>
                                </ul>
                            </li>


                            <li class="treeview">
                                <a href="#"> <i class="fa fa-users"></i> <span>Profil Dinas</span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                            ...
                            <!-- <li><a href="<?php echo site_url('admin/field/') ?>"><i class="fa fa-sitemap"></i> Bidang</a></li> -->
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo site_url('admin/news') ?>"><i class="fa fa-circle-o"></i> List Berita</a></li>
                                    <li><a href="<?php echo site_url('admin/news_category') ?>"><i class="fa fa-circle-o"></i> Kategori Berita</a></li>
                                </ul>
                            </li>

                            <!-- new for biro organisasi  -->
                            <!-- <li class="treeview">
                                <a href="#"> <i class="fa fa-home"></i> <span>Publikasi</span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo site_url('admin/publication') ?>"><i class="fa fa-circle-o"></i> List Publikasi</a></li>
                                    <li><a href="<?php echo site_url('admin/publication_category') ?>"><i class="fa fa-circle-o"></i> Kategori Publikasi</a></li>
                                </ul>
                            </li> -->


                            <!-- new for biro kominfo  -->
                            <li class="treeview">
                            ...
                            <!-- <li><a href="<?php //echo site_url('admin/regulation')
                                                ?>"><i class="fa fa-gavel"></i> <span>Produk Hukum</span></a></li> -->
                            <!-- end new -->
                            <li><a href="<?php echo site_url('admin/album') ?>"><i class="fa fa-photo"></i> <span>Album</span></a></li>

                            <li><a href="<?php echo site_url('admin/message') ?>"><i class="text-red fa fa-bullhorn"></i> <span>Pesan</span></a></li>
                            <!-- <li><a href="<?php echo site_url('admin/slider') ?>"><i class="fa fa-file-image-o"></i> <span>Slider Berita</span></a></li> -->
                            <!-- <li><a href="<?php echo site_url('admin/link_terkait') ?>"><i class="fa fa-external-link"></i> <span>Link Terkait</span></a></li> -->
