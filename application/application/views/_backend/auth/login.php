...
<html>
    ...
    <body class="hold-transition login-page fontPoppins" style="background-size: cover; background-image: url(<?php echo base_url();?>assets/core-images/bg-tes.png); background-position:bottom center;">
        <div class="login-box">
