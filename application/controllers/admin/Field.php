...
class Field extends CI_Controller
{
    ...
    public function detail_page()
    {
        ...
        $data['setting'] = getSetting();
        $data['title']   = 'Detail';
        $data['field']    = $this->m_field->get($this->uri->segment(4));

        // TEMPLATE
        $view         = "_backend/field/_detail";
        $viewCategory = "all";
        renderTemplate($data, $view, $viewCategory);
    }
    ...
    public function create()
    {
        ...
        $data['field_description'] = $this->input->post('field_description');
        $data['field_tupoksi'] = $this->input->post('field_tupoksi');
