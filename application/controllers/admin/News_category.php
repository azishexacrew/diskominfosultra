...
class News_category extends CI_Controller
{
    ...
    public function create()
    {
        ...
        // LOG
        $message    = $this->session->userdata('user_name') . " menambah data jenis berita " . $data['news_category_name'];
        createLog($message);

        // ALERT
        $alertStatus  = "success";
        $alertMessage = "Berhasil menambah data jenis berita " . $data['news_category_name'];
        getAlert($alertStatus, $alertMessage);
    ...
    public function update()
    {
        ...
        // LOG
        $message    = $this->session->userdata('user_name') . " mengubah data jenis berita dengan ID = " . $data['news_category_id'] . " - " . $data['news_category_name'];
        createLog($message);

        // ALERT
        $alertStatus  = "success";
        $alertMessage = "Berhasil mengubah data jenis berita : " . $data['news_category_name'];
        getAlert($alertStatus, $alertMessage);
    ...
    public function delete()
    {
        ...
        // LOG
        $message    = $this->session->userdata('user_name') . " menghapus data jenis berita dengan ID = " . $this->input->post('news_category_id') . " - " . $this->input->post('news_category_name');
        createLog($message);

        // ALERT
        $alertStatus  = "failed";
        $alertMessage = "Menghapus data jenis berita : " . $this->input->post('news_category_name');
        getAlert($alertStatus, $alertMessage);
